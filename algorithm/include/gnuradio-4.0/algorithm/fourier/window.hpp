 ...
 */
enum class Type : int { None, Rectangular, Hamming, Hann, Blackman, Nuttall, BlackmanHarris, BlackmanNuttall, FlatTop, Exponential, Kaiser, Bartlett, Welch, Parzen, Tukey, Gaussian };
using enum Type;
inline static constexpr gr::meta::fixed_string TypeNames = "[None, Rectangular, Hamming, Hann, Blackman, Nuttall, BlackmanHarris, BlackmanNuttall, FlatTop, Exponential, Kaiser, Bartlett, Welch, Parzen, Tukey, Gaussian]";
